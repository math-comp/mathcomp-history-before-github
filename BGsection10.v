...
Require Import bigop finset prime fingroup morphism automorphism quotient.
...
Lemma Sylow_Sylow_sigma : forall p P,
  p \in \sigma(M) -> p.-Sylow(M) P -> p.-Sylow([set: gT]) P.
Proof.
...
Implicit Types A Y S E : {group gT}.
