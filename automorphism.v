...
Lemma isom_card : forall H' : {set G'}, isom f H H' -> #|H| = #|H'|.
Proof.
move=> H'; move/andP=> [Him Hinj]; move/eqP: Him; move/setP.
move/eq_card; rewrite card_dimset //; apply/injmorphicP; apply:Hinj.
Qed.
