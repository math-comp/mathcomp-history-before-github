...
Lemma irr_IirrPE J (f : J -> 'CF(G)) (P : pred J) :
  (forall j, P j -> f j \in irr G) -> forall j, P j -> 'chi_(irr_Iirr f j) = f j.
Proof.
...
Proof. by rewrite cfker_charE ?irr_char. Qed.
...
by rewrite !cfker_irrE !inE Gx mem_quotient //= -iModI !cfModE ?morph1.
Qed.
