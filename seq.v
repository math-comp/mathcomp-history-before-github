...
rewrite -{1}(leq_sub_sub (ltnW Hs)) -{1}[size s]size_rotr; first exact: rotK.
...
move=> m n s; rewrite leq_eqVlt; case/setU1P=> [Emn|Hmn].
  by rewrite Emn rot_size -{1}(rotrK m s) /rotr -Emn subn_addr.
...
Proof.
move=> m n i Hi; rewrite -(leq_add_sub Hi) addSnnS iota_add.
