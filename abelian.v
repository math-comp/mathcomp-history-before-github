...
(* Lemmas on groups that are generated by intersection of groups *)

Section Generated_bis.

Variable (elt : finGroupType)(x : elt)(A B : {set elt}).

Lemma gen_sub : forall X Y : {set elt},
...
Lemma gen_pred0 : <<set0 : {set elt}>> = [set 1].
Proof.
