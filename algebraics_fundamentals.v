...
(* of the algebraics, such as the existence of minimal polynomials, tha are   *)
...
(*     d with |Mq[d]| < 1/2), so we can the sign of z to that of q in ab_n.   *)
...
(*     of Q that contains both z and z_ n, Q[x_n, z] = Q[z_n, z] is Galois    *)
...
(* (E) - Construct conj amd conclude (~40 lines): conj z is defined as        *)
