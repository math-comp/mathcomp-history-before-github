...
Feit-Thompson theorem, which states that every odd order
group is solvable. Its historical proof~\cite{feit-thompson} is
...
for further formalisations. It is then crucial for our formalisation
to scale up. We have therefore worked out a new development, with a
strong effort in proof engineering.

First, we reuse the \ssr{} extension of the \Coq{} system \cite{Coq:manual}
...
In Section 3, we comment on some of our choices in formalising
