...
(*                                 (fun x => a) and (fun x => r)             *)
(*          {morph f : x / a} == f is a morphism with respect to             *)
(*                                 (fun x => a)                              *)
(*  {morph f : x y / a >-> r} == f is a morphism with respect to functions   *)
(*                                 (fun x y => a) and (fun x y => r)         *)
(*        {morph f : x y / a} == f is a morphism with respect to             *)
(*                                 (fun x y => a)                            *)
(*     {homo f : x / a >-> r} == f is a homomorphism with respect to the     *)
(*                                 predicates (fun x => a) and (fun x => r), *)
(*                                 i.e., forall x, a -> (fun x => r) (f x)   *)
(*           {homo f : x / a} == f is a homomorphism with respect to         *)
(*                                 (fun x => a)                              *)
(*   {homo f : x y / a >-> r} == f is a homomorphism with respect to the     *)
(*                                 relations (fun x y => a)                  *)
(*                                 and (fun x y => r)                        *)
(*         {homo f : x y / a} == f is a homomorphism with respect to         *)
(*                                 (fun x y => a)                            *)
(*     {mono f : x / a >-> r} == f is "monotone" with respect to projections *)
(*                                 (fun x => a) and (fun x => r), i.e.,      *)
(*                                 forall x, (fun x => r) (f x) = a          *)
(*           {mono f : x / a} == f is monotone with respect to (fun x => a)  *)
(*   {mono f : x y / a >-> r} == f is monotone with respect to relations     *)
(*                                 (fun x y => a) and (fun x y => r)         *)
(*         {mono f : x y / a} == f is monotone with respect to               *)
(*                                 (fun x y => a)                            *)
(*                                                                           *)
